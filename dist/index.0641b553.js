...
const fetchUsers = async ()=>{
    ...
    tabUsers.forEach((element)=>{
        ...
        new (0, _user.User)(element.name.title, element.name.first, element.name.last, element.location.city, element.location.country, element.dob.age, element.email, element.picture.large).render(main);
    });
...
},{"./User":"3Nf0z"}],"3Nf0z":[function(require,module,exports) {
...
`;
    ...
    changePesent() {
        if (this.#present == true) this.#present = false;
    }
}
